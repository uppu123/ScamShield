...
.stApp { background:var(--bg); font-family:'Inter',-apple-system,'Segoe UI',sans-serif; }
...
.stTextArea textarea:focus, .stTextInput input:focus { border-color:#4f46e5; box-shadow:0 0 0 2px rgba(79,70,229,.15); }
